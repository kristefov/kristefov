...
const Contact = () => {
 ...
 state is used to store the values entered by the user in the contact form. */
  ...
  const handleSubmit = () => {
    setErrorMessage(
      "In development mode for contact please use the email provided instead"
    );
    setTimeout(() => {
      console.log(setTimeout);
      setErrorMessage("");
      ...
      <div className="contact__container container grid">
        <div className="contact__data">
          ...
          <div className="contact__socials">
            ...
            <a
              href="https://twitter.com/kristefov"
              className="contact__social-link"
            >
              <FaTwitter />
            </a>
            <a
              href="https://www.youtube.com/CyberCubeTV"
              className="contact__social-link"
            >
              <FaYoutube />
            </a>
            <a
              href="https://linktr.ee/kristiyantefov"
              className="contact__social-link"
            >
              <SiLinktree />
            </a>
